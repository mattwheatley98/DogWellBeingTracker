package com.mw.dogwellbeingtracker.presentation.bottom_bar_screens.food_tracker
...
import com.mw.dogwellbeingtracker.presentation.common.LogColumnTitle
import com.mw.dogwellbeingtracker.presentation.common.LogEntry
...
fun FoodTrackerLogScreen(viewModel: FoodTrackerViewModel = hiltViewModel()) {
    ...
    CalorieTrackerLogBody(
        ...
        foodList = foodListUiState.foodList.sortedByDescending { it.date }
            .filter { it.dogId == selectedDogUiState.selectedDog.id },
    )
}
