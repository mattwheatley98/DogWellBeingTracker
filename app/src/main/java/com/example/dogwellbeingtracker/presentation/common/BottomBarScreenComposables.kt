...
fun DateField(
    ...
    CalendarDialog(
        ...
        selection = CalendarSelection.Date { date ->
            onValueChange(DateTimeFormatter.ofPattern("MM/dd/yy").format(date))
        },
...
fun TimeField(
    ...
    ClockDialog(
        state = clockState,
        config = ClockConfig(is24HourFormat = false, defaultTime = LocalTime.now()),
        selection = ClockSelection.HoursMinutes { hours, minutes ->
            onTimeValueChange("$hours:$minutes")
        },
